...
@Entity
@Table(name = "property")
@SQLDelete(sql = "UPDATE property SET deleted = true, updated_at = CURRENT_TIMESTAMP WHERE id = ?")
...
public class Property {
    ...
    private String status = "DELISTED";

    @Column(name = "rent", nullable = false, precision = 12, scale = 2)
